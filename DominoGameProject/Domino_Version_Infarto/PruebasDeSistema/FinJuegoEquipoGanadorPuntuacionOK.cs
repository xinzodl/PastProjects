...
namespace PruebasDeSistema
{
    ...
    /// </summary>
    [CodedUITest]
    public class FinJuegoEquipoGanadorPuntuacionOK
    {
        public FinJuegoEquipoGanadorPuntuacionOK()
        {
        }

        [TestMethod]
        public void finJuegoEquipoGanadorAvisoPuntuacion()
        {
            ...
            this.UIMap.FinJuegoEquipoGanadorAvsoPuntuacion();
        }
