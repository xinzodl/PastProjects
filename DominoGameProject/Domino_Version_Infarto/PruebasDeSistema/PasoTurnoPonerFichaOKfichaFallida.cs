...
namespace PruebasDeSistema
{
    ...
    /// </summary>
    [CodedUITest]
    public class PasoTurnoPonerFichaOKfichaFallida
    {
        public PasoTurnoPonerFichaOKfichaFallida()
        {
        }

        [TestMethod]
        public void pasarTurnoPonerFichaFichaInvalida()
        {
            ...
            this.UIMap.JugadorPasarTurno();
            this.UIMap.PonerFichaEnMesa();
            this.UIMap.IntentoPonerFichaFallida();
        }
