...
namespace PruebasDeSistema
{
    ...
    /// </summary>
    [CodedUITest]
    public class finMano0fichasGiroPiezaPuntos
    {
        public finMano0fichasGiroPiezaPuntos()
        {
        }

        [TestMethod]
        public void finManoFich0()
        {
            ...
            this.UIMap.FichaGiraEnBordeOK();
            this.UIMap.FinManoOfichasPuntosActualizados();
        }
